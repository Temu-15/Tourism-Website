...
//   return (
//     <div
//       className="w-full h-full md:h-[550px] block md:flex justify-between p-12"
//       style={myStyle}
//     >
//       <div className="h-full flex flex-col justify-center items-start w-[40%]">
//         <h2 className="font-bold color-[#05073c] text-[40px] leading-[52px] w-[366px] mb-[10px]">
//           Grab up to <span className="text-[#EB6628]">35% off</span> on your
//           favorite Destination
//         </h2>
//         <p className="font-normal color-[#05073c] text-[16px] leading-[28px] w-[366px] mb-[15px]">
//           Limited time offer, don't miss the opportunity
//         </p>
//         <button className="w-[168px] h-[64px] bg-[#EB662B] rounded-[12px]">
//           Book here
//         </button>
//       </div>
